...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,786 | 🐛 102 | 📅 2026-08-18, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,609 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,562 | 🐛 26 | 📅 2026-05-03.
...
* [Awesome SFML](https://github.com/JustCaptcha/awesome-sfml) ⭐ 109 | 🐛 0 | 📅 2026-04-19
...
* [imgui-sfml](https://github.com/eliasdaler/imgui-sfml) ⭐ 1,361 | 🐛 29 | 🌐 C++ | 📅 2026-08-18 - ImGui binding for use with SFML.
...
* [Swoosh](https://github.com/TheMaverickProgrammer/Swoosh) ⭐ 74 | 🐛 7 | 🌐 Objective-C | 📅 2024-06-24 - SFML Activity and Segue Mini Library
* [SFNUL](https://github.com/binary1248/SFNUL) ⭐ 51 | 🐛 1 | 🌐 C++ | 📅 2018-06-12 - Simple and Fast Network Utility Library.
* [RichText](https://github.com/skyrpex/RichText) ⭐ 47 | 🐛 0 | 🌐 C++ | 📅 2020-01-28 - Rich text class for SFML2. Allows the user to draw lines of text with different styles and colors.
* [SFML-utils](https://github.com/Krozark/SFML-utils) ⭐ 27 | 🐛 5 | 🌐 C++ | 📅 2020-11-23 - Some adds to build games.
* [SFMLSoundSystem](https://github.com/Hapaxia/SfmlSoundSystem) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2025-05-18 - Sound Control System for use with SFML.
...
* [Nim](https://github.com/oprypin/nim-csfml) ⭐ 86 | 🐛 0 | 🌐 Nim | 📅 2022-10-16
...
* D
  * [DerelictSFML2](https://github.com/DerelictOrg/DerelictSFML2) ⭐ 25 | 🐛 1 | 🌐 D | 📅 2022-07-07
  * [DSFML](http://www.dsfml.com/)
* Go
  * [go-sfml](https://github.com/teh-cmc/go-sfml) ⭐ 152 | 🐛 2 | 🌐 C | 📅 2022-08-06
  * [GoSFML2](https://bitbucket.org/krepa098/gosfml2)
* [Java](https://jsfml.sfmlprojects.org/)
* OCaml
  * [ocaml-sfml](https://github.com/fccm/ocaml-sfml) ⭐ 26 | 🐛 2 | 🌐 C++ | 📅 2022-08-07
  * [Ocsfml](https://github.com/JoeDralliam/Ocsfml) ⭐ 17 | 🐛 0 | 🌐 OCaml | 📅 2015-11-01

## Utilities

*Non-Game specific Library bundles, that provide reuseable functions*

* [tmxlite](https://github.com/fallahn/tmxlite) ⭐ 464 | 🐛 12 | 🌐 C++ | 📅 2026-04-27 -  Lightweight C++14 parser for Tiled tmx files.
...
* [www.sfml-dev.org](https://www.sfml-dev.org/) - Official site.
  ...
  * The [community wiki](https://github.com/SFML/SFML/wiki/) ⭐ 11,988 | 🐛 153 | 🌐 C++ | 📅 2026-08-18
...
* [Building Games with SFML](https://github.com/PacktPublishing/Building-Games-with-SFML) ⭐ 11 | 🐛 0 | 🌐 C++ | 📅 2021-01-20 - A step-by-step introduction to SFML to help you build enjoyable, cross-platform games
...
* [is::Engine](https://github.com/Is-Daouda/is-Engine) ⭐ 233 | 🐛 2 | 🌐 C | 📅 2026-07-07 - Game Engine developed with the SFML library to create games on Android and PC
...
* [HopsonCraft](https://github.com/Hopson97/HopsonCraft) ⭐ 644 | 🐛 7 | 🌐 C++ | 📅 2024-02-17 - A minecraft clone written using C++, SFML, OpenGL and GLEW.
...
* [Hedgehogs Can Fly](https://github.com/yyamDev/ballfling) ⭐ 9 | 🐛 0 | 🌐 C++ | 📅 2019-05-16 - 2D physics platformer game.
* [Racod's Lair](https://github.com/cgloeckner/racods-lair) ⚠️ Archived - 2D Rogue-inspired Action Dungeoncrawler
...
* [Da Music Player](https://github.com/Drimiteros/Da-music-player) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2025-04-21 - A simple, retro, music player that uses SFML for handling the UI and Sound.

## Other

* [Stylish Visualizer](https://github.com/CosminPerRam/StylishVisualizer) ⭐ 20 | 🐛 4 | 🌐 C++ | 📅 2025-12-03 - A sorting algorithms visualizer which features SFX, step by step control and many personalization options.
